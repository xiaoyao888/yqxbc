...
function checkcomment(theform)
{
	...
	success:function(t0)
	{
		...
		if(t0.substring(0,1)==0){theform.username.value='';}
		}
	});
}
...
//返回顶部
document.write("<DIV style='display:none;' id=gotop class='gotop'><IMG border=0 src='/templets/default/images/gotop.jpg' alt='返回顶部' width='48' height='48'></DIV>");
