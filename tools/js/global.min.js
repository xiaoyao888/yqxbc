...
function changeNumMoneyToChinese(t) {
    var e, n, i, o = new Array("零", "壹", "贰", "叁", "肆", "伍", "陆", "柒", "捌", "玖"), r = new Array("", "拾", "佰", "仟"),
        a = new Array("", "万", "亿", "兆"), s = new Array("角", "分", "毫", "厘"), l = "";
    if ("" == t) return "";
...
function navActive(item){
    for(let i = 1;i<=9;i++){
        document.getElementById("nav-content"+i).style.display="none";
        if(i === item){
            document.getElementById("nav-content"+item).style.display="block";
        }
